...
Joystick_ Joystick(0x16, JOYSTICK_TYPE_JOYSTICK, 2, 0, true, true, false, false, false, true, false, false, false, false, false);  //Make sure that hex value is unique, update as needed.
...
void loop()
{
  ...
  if (BNO080_.dataAvailable() == true)
  {
      ...
      lastPauseState = setButtonState(currentPauseState, lastPauseState, 1);
